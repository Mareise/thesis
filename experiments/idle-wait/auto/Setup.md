# Initial Setup
**Script = evaluation_script/idle-wait.py**

**Idle time = 2000ms**

**Only with Dynamic-reevaluation**
...
- name: THRESHOLD_REQUEST_RATE_COLD_START_MITIGATION # When request rate in the last minute is below this, we dont take actions
  value: "0.1"
